...
use crate::ast_step4::{
    self, Block, GlobalVariable, LocalVariable, Tester, TypeId, VariableDecl,
};
...
struct Env {
    ...
    data_decl_map: FxHashMap<DeclId, ast_step4::ConstructorId>,
    build_env: ast_step4::Env,
}

pub fn convert(ast: ast_step3::Ast) -> ast_step4::Ast {
    ...
    env.build_env.build_ast4(entry_point)
}
